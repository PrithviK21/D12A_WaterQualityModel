...
class HomeView(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'jalrakshanback/index.html')
...
class ChartData(APIView):
    ...
    df = pd.read_excel("jalrakshanback/wqilimitriver_morethanequalto5.xlsx")
...
class CountWQIData(APIView):
    ...
    def get(self, request, format=None):
        ...
        # print(statename)
        # dfstate = pd.read_excel("jalrakshanback/templates/jalrakshanback/wqilimitstate.xlsx")
...
class HeatmapViews(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'jalrakshanback/heatmap.html')
...
class CompareViews(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'jalrakshanback/compare.html')
...
class CompareData(APIView):
    ...
    def get(self, request, format=None):
        ...
        firstriverload = joblib.load(
            'jalrakshanback/templates/jalrakshanback/river_models/'+firstrivername+'.pkl')
        ...
        secondtriverload = joblib.load(
            'jalrakshanback/templates/jalrakshanback/river_models/'+secondrivername+'.pkl')
...
class ModelRiverViews(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'jalrakshanback/modelriver.html')
...
class ModelRiverData(APIView):
    ...
    def get(self, request, format=None):
        ...
        riverload = joblib.load(
            'jalrakshanback/templates/jalrakshanback/river_models/'+rivername+'.pkl')
...
class GetDatasetAsPDF(APIView):
    ...
    permission_classes = []
    def get(self, request, format=None):
        filename = "jalrakshanback/templates/jalrakshanback/JalrakshanData.pdf"
...
class Dataset(APIView):
    ...
    df = pd.read_excel(
        "jalrakshanback/templates/jalrakshanback/Only_Rivers_groupby_interpolated.xlsx")
